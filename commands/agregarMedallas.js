...
// Descripción del modulo
    ...
    async execute(interaction) {
        ...
        .setDescription(`Le estás agregando medallas a <@${newuserid.id}>: ${medallaoro} <:oro:904439890777874452> ${medallaplata} <:plata:904439889175642142> ${medallabronce} <:bronce:904439889867702324> ${medallahierro} <:hierro:904439890417180683> ${medallamadera} <:carton:904439891037929522>`);
