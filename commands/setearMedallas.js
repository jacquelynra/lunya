...
// Descripción del modulo
    ...
    async execute(interaction) {
        ...
        .setDescription(`Le estás seteando medallas a <@${newuserid.id}>: ${medallaoro} <:oro:904816810812145694> ${medallaplata} <:silver:904816810568843285> ${medallabronce} <:bronze:904816810224930858> ${medallahierro} <:iron:904816810686287922> ${medallamadera} <:carton:904816810803757096>`);
